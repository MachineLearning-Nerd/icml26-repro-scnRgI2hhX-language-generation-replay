...
---
<!-- trackio-cell
{"type": "code", "id": "cell_0a2c3a16bb16", "created_at": "2026-07-29T11:46:13+00:00", "title": "verify six source constructions", "command": ["python3", "repro/src/verify.py"], "exit_code": 0, "duration_s": 0.103}
-->
````bash
...
````output
{
  ...
  "claim_count": 6,
  "claims": {
    "claim_1_uniform_replay_equivalence": true,
    "claim_2_countable_nonuniform_separation": true,
    "claim_3_wp_countable_limit_generation": true,
    "claim_4_uncountable_limit_separation": true,
    "claim_5_proper_membership_query_lower_bound": true,
    "claim_6_finite_proper_replay_hardness": true
  }
}
...
---
<!-- trackio-cell
{"type": "code", "id": "cell_d8f00938a96f", "created_at": "2026-07-29T11:46:14+00:00", "title": "strict publication gate", "command": ["python3", "repro/src/publication_gate.py"], "exit_code": 0, "duration_s": 0.067}
-->
````bash
