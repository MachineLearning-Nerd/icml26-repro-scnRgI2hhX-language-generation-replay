...
def main() -> None:
    ...
    exact_claims = {"claim_6": certify_c6_cells()}
    assert exact_claims["claim_6"]["verdict"] == "VERIFIED"
    result = {
        "paper": "scnRgI2hhX",
        "arxiv": "2603.11784",
    ...
    (OUT / "c6_cell_certificate.json").write_text(json.dumps(exact_claims["claim_6"], indent=2, sort_keys=True) + "\n")
    ...
    print("C6_CELL_RESULT=" + json.dumps(exact_claims["claim_6"], sort_keys=True))
